...
-- Ask for URL
try
	set dialogRes to display dialog "Paste the file URL:" default answer "" with title "DownStream" buttons {"Cancel", "OK"} default button "OK"
...
try
	...
	set dialogRes to display dialog "Output filename (leave blank to auto-detect):" default answer defaultName with title "DownStream" buttons {"Cancel", "OK"} default button "OK"
